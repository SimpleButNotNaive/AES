...
uint8 aes_encryptor::aes_abstract::s_box[16][16] = {
...
uint32 aes_encryptor::aes_abstract::r_cont[10] = {0x01000000, 0x02000000, 0x04000000, 0x08000000, 0x10000000, 
				 0x20000000, 0x40000000, 0x80000000, 0x1b000000, 0x36000000};

uint8 aes_encryptor::aes_abstract::mix_column_matrix[4][4] = {
	{0x02, 0x03, 0x01, 0x01},
	{0x01, 0x02, 0x03, 0x01},
	{0x01, 0x01, 0x02, 0x03},
	{0x03, 0x01, 0x01, 0x02},
...
void aes_encryptor::encryption(string p_text, string key, string init_vector) {
